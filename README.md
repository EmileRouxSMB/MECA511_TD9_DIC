...
# The one minute install guide with (mini)conda
Just run the following shell commands 
```shell
# create and activate a conda environment
conda create -n pydic pip python=3.10
conda activate pydic

# download pydic
git clone https://gitlab.com/damien.andre/pydic.git 

# install 3rd party libs
pip install opencv-python opencv-contrib-python scipy matplotlib

# go into an example directory 
cd pydic/examples/tension-test
